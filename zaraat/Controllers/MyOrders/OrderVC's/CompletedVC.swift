...
class CompletedVC: UIViewController, IndicatorInfoProvider  {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        extension CompletedVC : UITableViewDelegate, UITableViewDataSource {
            ...
            func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
                if self.progressData?.orders?[indexPath.row].status == "completed" {
...
extension CompletedVC: DZNEmptyDataSetSource,DZNEmptyDataSetDelegate {
