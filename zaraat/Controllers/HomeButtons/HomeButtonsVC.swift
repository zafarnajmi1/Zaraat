...
class HomeButtonsVC: UIViewController {
    ...
    @IBOutlet weak var searchView: UIView!
     ...
     extension HomeButtonsVC :  UITableViewDelegate, UITableViewDataSource {
         ...
         func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
             if indexPath.section == 1 {
                 let cell =  tableView.dequeueReusableCell(withIdentifier: "HomeButtonPartOneCell") as? HomeButtonPartOneCell
                 return (cell?.ClView.contentSize.height)! + 1500
             } else if indexPath.section == 3 {
                 let cell =  tableView.dequeueReusableCell(withIdentifier: "HomeButtonPartTwoCell") as? HomeButtonPartTwoCell
                 return (cell?.ClView.contentSize.height)! + 1500
             }else  {
         ...
         func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
             ...
             let cell =  tableView.dequeueReusableCell(withIdentifier: "HomeButtonsStoreForyouCell") as? HomeButtonsStoreForyouCell
             return cell!
             } else if indexPath.section == 1 {
                 let cell =  tableView.dequeueReusableCell(withIdentifier: "HomeButtonPartOneCell") as? HomeButtonPartOneCell
                        return cell!
             } else if indexPath.section == 2 {
                 let cell =  tableView.dequeueReusableCell(withIdentifier: "HomeButtonAdsCell") as? HomeButtonAdsCell
                 return cell!
             } else {
                 let cell =  tableView.dequeueReusableCell(withIdentifier: "HomeButtonPartTwoCell") as? HomeButtonPartTwoCell
                 return cell!
