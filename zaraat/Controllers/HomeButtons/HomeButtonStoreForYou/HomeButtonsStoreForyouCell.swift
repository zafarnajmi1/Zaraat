//
//  HomeButtonsStoreForyouCell.swift
//  zaraat
//
...
class HomeButtonsStoreForyouCell: UITableViewCell {
   ...
   @IBOutlet weak var ClView: UICollectionView!
    ...
    extension HomeButtonsStoreForyouCell :  UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
