...
class ZPharmacyPartOneCell: UITableViewCell {
...
//               }
    ...
    extension ZPharmacyPartOneCell :  UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
