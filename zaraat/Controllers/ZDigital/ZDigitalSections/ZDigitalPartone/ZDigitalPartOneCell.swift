...
class ZDigitalPartOneCell: UITableViewCell {
    ...
    //               }
        ...
        extension ZDigitalPartOneCell :  UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
