...
struct ZMartModel : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(ZMartData.self, forKey: .data)
...
struct ZMartData : Codable {
    let ad_1 : Ad_1?
        let subcategories : [ ZMartSubcategories]?
        let daily : [ZMartDaily]?
        let section_1 : [ZMartSection_1]?
        let ad_2 : Ad_2?
        let section_2 : [ZMartSection_2]?
        ...
        init(from decoder: Decoder) throws {
            ...
            subcategories = try values.decodeIfPresent([ZMartSubcategories].self, forKey: .subcategories)
            daily = try values.decodeIfPresent([ZMartDaily].self, forKey: .daily)
            section_1 = try values.decodeIfPresent([ZMartSection_1].self, forKey: .section_1)
            ad_2 = try values.decodeIfPresent(Ad_2.self, forKey: .ad_2)
            section_2 = try values.decodeIfPresent([ZMartSection_2].self, forKey: .section_2)
        }

    }


struct ZMartSubcategories : Codable {
