...
struct WishlistModel : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        wishlist = try values.decodeIfPresent([Wishlist].self, forKey: .wishlist)
...
struct Wishlist : Codable {
    ...
    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        wishlist_id = try values.decodeIfPresent(Int.self, forKey: .wishlist_id)
        product_id = try values.decodeIfPresent(Int.self, forKey: .product_id)
        customer_id = try values.decodeIfPresent(Int.self, forKey: .customer_id)
        created_at = try values.decodeIfPresent(String.self, forKey: .created_at)
        updated_at = try values.decodeIfPresent(String.self, forKey: .updated_at)
        product = try values.decodeIfPresent(wishlistProduct.self, forKey: .product)
    }
