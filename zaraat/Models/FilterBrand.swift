...
struct FilterBrand : Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case childcategories = "childcategories"
        case status = "status"
    ...
    init(from decoder: Decoder) throws {
        ...
        childcategories = try values.decodeIfPresent([Childcategories].self, forKey: .childcategories)
...
struct Childcategories : Codable {
