//
//  EcommrceCateModel.swift
//  zaraat
//
//  Created by ZafarNajmi on 10/12/20.
//  Copyright © 2020 User. All rights reserved.
//

import Foundation
struct EcommerceCateModel : Codable {
    let message : String?
        let categories : [EcommerceCategories]?
        let status : Int?
        let success : Int?
        ...
        init(from decoder: Decoder) throws {
            ...
            categories = try values.decodeIfPresent([EcommerceCategories].self, forKey: .categories)
...
struct EcommerceCategories : Codable {
