...
import Foundation
struct TrendingProductsModels : Codable {
    let message : String?
    let data : TrendingProductsData?
    let status : Int?
    let success : Int?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(TrendingProductsData.self, forKey: .data)
...
struct TrendingProductsSection_2 : Codable {
    let products_id : Int?
    let vendor_id : Int?
    let category_id : Int?
...
struct TrendingProductsSection_1 : Codable {
    let products_id : Int?
    let vendor_id : Int?
    let category_id : Int?
    let subcategory_id : Int?
...
struct TrendingProductsData : Codable {
    let section_1 : [TrendingProductsSection_1]?
    let section_2 : [TrendingProductsSection_2]?
    let ad : TrendingProductsAd?
    ...
    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        section_1 = try values.decodeIfPresent([TrendingProductsSection_1].self, forKey: .section_1)
        section_2 = try values.decodeIfPresent([TrendingProductsSection_2].self, forKey: .section_2)
        ad = try values.decodeIfPresent(TrendingProductsAd.self, forKey: .ad)
    }

}
struct TrendingProductsAd : Codable {
    let categories_id : Int?
    let market : String?
    let category_title_en : String?
    let category_title_urdu : String?
